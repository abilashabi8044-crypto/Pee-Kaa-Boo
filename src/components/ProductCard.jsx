        ...
        return (
            ...
            >
                ...
                <div className="absolute bottom-0 inset-x-0 bg-white m-[6px] md:m-[10px] rounded-[10px] p-2 md:p-3 text-center z-10 transition-all duration-300 shadow-sm">
                    ...
                    <h4 className={`text-[#333] font-['Nunito'] font-bold leading-tight mb-1 md:mb-1.5 tracking-wide md:group-hover:text-base md:group-hover:mb-2 transition-all duration-300 ${isHomepage ? 'text-base' : 'text-xs'} md:text-lg`}>{title}</h4>

                    <div className="flex justify-center items-center gap-1 md:gap-2 mb-0 md:group-hover:mb-3 transition-all duration-300">
                        <span className={`text-gray-400 font-['Nunito'] font-medium line-through ${isHomepage ? 'text-md' : 'text-xs'} md:text-sm`}>₹ {oldPrice}</span>
                        <span className={`text-[#F76188] font-['Nunito'] font-bold md:group-hover:text-xl transition-all ${isHomepage ? 'text-base' : 'text-xs'} md:text-xl`}>₹ {price}</span>
                    </div>
