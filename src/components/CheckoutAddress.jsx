            ...
            <div className="flex overflow-x-auto sm:grid sm:grid-cols-3 gap-4 pb-2 sm:pb-0 snap-x" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
              {giftWraps.map(wrap => (
                <div
                  ...
                  className={`rounded-[16px] overflow-hidden cursor-pointer border-2 transition-all flex flex-col w-[calc(50%-8px)] sm:w-full flex-shrink-0 sm:flex-shrink snap-start ${selectedGiftWrap === wrap.id ? 'border-[#F96E8F] scale-[1.02] shadow-xl' : 'border-transparent shadow-md'}`}
                >
