                ...
                <div className="bg-white rounded-[24px] p-8 md:p-12 shadow-sm border border-gray-200">
                    ...
                    <div className="text-gray-700 font-['Nunito'] text-[15px] leading-relaxed space-y-8">
                        ...
                        <div className="border-t border-dashed border-gray-200 pt-6">
                            <h3 className="text-[18px] font-black text-gray-900 mb-4 font-['Baloo_2'] flex items-center gap-2">
                                <span>🌟</span> Current Highlight Deals
                            </h3>
                            <div className="space-y-4 font-['Nunito']">
                                <div className="bg-[#FFF0F4] p-5 rounded-2xl border border-pink-100">
                                    <p className="font-bold text-gray-800 text-[16px] mb-1">The Festive Radiance Sale</p>
                                ...
                                <div className="bg-[#FFF0F4] p-5 rounded-2xl border border-pink-100">
                                    <p className="font-bold text-gray-800 text-[16px] mb-1">Zero Making Charges</p>
                                    <p className="text-gray-600">Enjoy 0% making charges on all 22K Gold chains and bangles this weekend only.</p>
                                </div>

                                <div className="bg-[#FFF0F4] p-5 rounded-2xl border border-pink-100">
                                    <p className="font-bold text-gray-800 text-[16px] mb-1">Bridal Trousseau Special</p>
                        ...
                        <div className="border-t border-dashed border-gray-200 pt-6">
                            <h3 className="text-[18px] font-black text-gray-900 mb-3 font-['Baloo_2'] flex items-center gap-2">
                                <span>🎁</span> Welcome to the Family
                            </h3>
                            <p className="font-bold text-gray-805 text-[16px] mb-1">Your First Purchase, Rewarded.</p>
                            ...
                            <button className="bg-[#F96E8F] hover:bg-[#E44971] text-white font-extrabold px-6 py-3 rounded-full text-[14px] shadow-sm transition-all tracking-wide cursor-pointer font-['Nunito']">
